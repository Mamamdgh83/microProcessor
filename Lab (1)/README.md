...
**خطاهای احتمالی :**
* گاهی وقت ها ممکن است مدار به درستی کار نکند و یا به اصطلاحا به باگ بخورد 'Bug' در چنین شرایطی میتوان از دکمه ریست 'Reset' در گوشه برد آردینو استفاده کرد تا برنامه و مدار به درستی کار کنند.
**توضیحات شماتیک:**
